...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Hotelfooddefaults / Edit #{{$hotelfooddefault->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('hotelfooddefaults.update', $hotelfooddefault->id) }}" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('hotel_id')) has-error @endif">
                       <label for="hotel_id-field">Hotel_id</label>
                    <input type="text" id="hotel_id-field" name="hotel_id" class="form-control" value="{{ is_null(old("hotel_id")) ? $hotelfooddefault->hotel_id : old("hotel_id") }}"/>
                    ...
                    <input type="text" id="food_id-field" name="food_id" class="form-control" value="{{ is_null(old("food_id")) ? $hotelfooddefault->food_id : old("food_id") }}"/>
                    ...
                    <input type="text" id="price-field" name="price" class="form-control" value="{{ is_null(old("price")) ? $hotelfooddefault->price : old("price") }}"/>
                       @if($errors->has("price"))
                    ...
                    <input type="text" id="recurringtype-field" name="recurringtype" class="form-control" value="{{ is_null(old("recurringtype")) ? $hotelfooddefault->recurringtype : old("recurringtype") }}"/>
                    ...
                    <input type="text" id="recurringcount-field" name="recurringcount" class="form-control" value="{{ is_null(old("recurringcount")) ? $hotelfooddefault->recurringcount : old("recurringcount") }}"/>
                    ...
                    <input type="text" id="maximum quality-field" name="maximum quality" class="form-control" value="{{ is_null(old("maximum quality")) ? $hotelfooddefault->maximum quality : old("maximum quality") }}"/>
                    ...
                    <input type="text" id="photos-field" name="photos" class="form-control" value="{{ is_null(old("photos")) ? $hotelfooddefault->photos : old("photos") }}"/>
