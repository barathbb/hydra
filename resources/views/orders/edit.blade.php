        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('orders.update', $order->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('“profileid')) has-error @endif">
                    ...
                    <input type="text" id="“profileid-field" name="“profileid" class="form-control" value="{{ is_null(old("“profileid")) ? $order->“profileid : old("“profileid") }}"/>
                    ...
                    <input type="text" id="hotels-field" name="hotels" class="form-control" value="{{ is_null(old("hotels")) ? $order->hotels : old("hotels") }}"/>
                    ...
                    <input type="text" id="dineparcel-field" name="dineparcel" class="form-control" value="{{ is_null(old("dineparcel")) ? $order->dineparcel : old("dineparcel") }}"/>
                    ...
                    <input type="text" id="dinecount-field" name="dinecount" class="form-control" value="{{ is_null(old("dinecount")) ? $order->dinecount : old("dinecount") }}"/>
